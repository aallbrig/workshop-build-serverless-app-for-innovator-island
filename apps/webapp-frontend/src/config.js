...
export const appConfig = {
  // MODULE 1- BACKEND
  initStateAPI: 'https://251h3uq1h2.execute-api.us-east-2.amazonaws.com/Prod/InitState/', // e.g. https://12abcdef89.execute-api.us-west-2.amazonaws.com/Prod/InitState/
  // MODULE 2 - REALTIME
  iot: {
