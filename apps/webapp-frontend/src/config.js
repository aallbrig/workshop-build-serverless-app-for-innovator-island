...
export const appConfig = {
  // MODULE 1- BACKEND
  initStateAPI: 'https://svs05cpsxj.execute-api.us-east-2.amazonaws.com/Prod/InitState/', // e.g. https://12abcdef89.execute-api.us-west-2.amazonaws.com/Prod/InitState/
  // MODULE 2 - REALTIME
  iot: {
    poolId: 'us-east-2:ff498477-25ad-44cb-814a-a3d921004d29', // e.g. 'us-west-2:1abcdef-1234-abcd-1234-abcde123456'
